...
// func ForwardThreadMessageToDM(db *storage.Database, req models.ForwardThreadMessageRequest, logger *utility.Logger, userID string) {
...
// 		ForwardedFromChannelName: originalMsg.ChannelName,
