...
// 	// Set up the context for how long the connection should stay open
// 	idleTimer := time.NewTimer(connectionIdleTimeout)
...
// 			}
// 			// Reset the idle timer after each successful push
// 			if !idleTimer.Stop() {
// 				<-idleTimer.C
// 			}
// 			idleTimer.Reset(connectionIdleTimeout)
// 		case <-idleTimer.C:
// 			// Close the connection after the idle timeout
...
// 	connectionIdleTimeout = 3000 * time.Second
// )
