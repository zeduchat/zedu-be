describe("To retreive channel", () => {
    ...
    it("should retrieve the created channel successfully", () => {
      cy.request({
        ...
        expect(response.body.data).to.have.property("description", newChannel.description);
        expect(response.body.data).to.have.property("organisation_id", organisation_id);
      });
    });
