...
func CORS() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.Writer.Header().Add("Access-Control-Allow-Origin", "https://staging.telex.im")
		c.Writer.Header().Add("Access-Control-Allow-Origin", "https://telex.im")
		c.Writer.Header().Add("Access-Control-Allow-Origin", "http://localhost*")
