...
func Search(r *gin.Engine, ApiVersion string, validator *validator.Validate, db *storage.Database, logger *utility.Logger) *gin.Engine {
	...
	{
		searchUrl.GET("/search/user/:userId/organisations/:orgId", search.Search)
	}
	return r
}
